          ...
          <div class="card-body">
            <form action="" method="POST">
             ...
             {{-- email --}}
              ...
              {{-- check roles --}}
{{--              <div class='row mb-3'>--}}
{{--              <label class="col-sm-2 col-form-label" for="basic-default-company">rolse teacher</label>--}}
{{--              <div class="col-sm-10">--}}
{{--                <input type="checkbox" id="horns" name="role" value="">--}}
{{--                <label for="horns">give him teacher roles</label>--}}
{{--              </div>--}}
{{--            </div>--}}
