...
{{--              </span>--}}
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item active">
                <a href="{{route('all_teachers')}}" class="menu-link">
                  <i class="menu-icon tf-icons bx bx-home-circle"></i>
              ...
              {{-- manage student --}}
              <li class="menu-header small text-uppercase">
                <span class="menu-header-text">manage students</span>
              </li>
              <li class="menu-item active">
                  <a href="{{route('all_students')}}" class="menu-link">
                    <i class="menu-icon tf-icons bx bx-home-circle"></i>
        ...
        <div class="layout-page">
          ...
          >
            ...
            <div class="navbar-nav-right d-flex align-items-center justify-around" id="navbar-collapse">
              <!-- Search -->
                <div class="navbar-nav align-items-center col-10">
